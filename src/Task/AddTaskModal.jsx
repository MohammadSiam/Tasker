...
export default function AddTaskModal({ onSave, taskToUpdate, onCloseClick }) {
  ...
  const [isAdd, setIsAdd] = useState(Object.is(taskToUpdate, null)); //eita true return kobe jdi taskToUpdate null hoi,nyto false
  //isAdd jdi false jay tahole TaskBoard bujbe existing task k update korte hbe.
